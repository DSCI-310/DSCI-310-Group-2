...
```{r correlation, echo=FALSE, fig.dim = c(8, 6), fig.cap="Accuracy of K-NN Model with Neighbors"}
...
```{r correlation, echo=FALSE, fig.dim = c(8, 6), fig.cap="Figure 6: Confusion Matrix of Results"}
