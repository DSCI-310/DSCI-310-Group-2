...
```{r load-data}
heart_disease <- read_csv("../data/processed-cleveland.csv")
head(heart_disease)
```
...
```{r confusion-matirx, echo=FALSE, fig.dim = c(8, 6), fig.cap="Figure 6: Confusion Matrix of Results"}
