...
variables_table <- read_csv("../../results/variables.csv")
...
````{r attribute box, echo=FALSE, fig.dim = c(8, 6), fig.cap="Distribution of Diagnosis."}
knitr::include_graphics("../../results/distribution_diagnosis.png")
````
...
````{r attribute box, echo=FALSE, fig.dim = c(8, 6), fig.cap="Correlation Between Variables."}
knitr::include_graphics("../../results/correlation_variables.png")
````
