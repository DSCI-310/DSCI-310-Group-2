...
all:results/accuracy_plot.png results/box_hd.png results/distribution_of_diagnosis.png results/variable_correlation.png results/accuracy_plot.png results/confusion_matrix.png doc/heart_disease.html doc/heart_disease.pdf
...
# render report
doc/heart_disease.html doc/heart_disease.pdf: results/box_hd.png results/distribution_of_diagnosis.png results/variable_correlation.png  doc/heart_disease.rmd doc/references.bib
